public class EnemyEscapedState : EnemyState
{
	private IEnemy.MachineBehavior _currentBehavior;

	public EnemyEscapedState(Enemy Enemy, EnemyStateMachine EnemyStateMachine, IEnemy.MachineBehavior defaultBehavior) : base(Enemy, EnemyStateMachine)
	{
